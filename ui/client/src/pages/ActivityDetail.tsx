...
export default function ActivityDetail() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div
        id="map-container"
        className="h-96 bg-[#16213e] rounded-2xl border border-slate-700/50 flex items-center justify-center"
      >
        <div className="text-center">
          ...
          <p className="text-slate-500 text-sm">Map will be rendered here</p>
        </div>
      </div>
